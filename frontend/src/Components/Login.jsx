        ...
        <div style={{paddingTop:'12em'}}>
            ...
            <form onSubmit={handleSubmit}>    
                <div className="item">
                    ...
                    <br />
                    <input class="form-control" type="email" name="email" placeholder="enter email" value={data.email} onChange={handleChange}/>
                </div>
                <div className="item">
                    <label style={{fontSize:'1.2rem'}}>Enter Password</label>
                    <br />
                    <input class="form-control" type="password" name="password" placeholder="enter password" value={data.password} onChange={handleChange}/>
                </div>
